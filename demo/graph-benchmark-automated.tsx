// Automated version of graph-benchmark.tsx — entry point.
//
// Per-implementation code lives in ./bench/{signal,jotai,zustand,mobx,
// react-memo}.tsx so each library's pattern can be read in isolation.
// This file just imports each Graph component, wires the dispatcher, and
// renders the toolbar + MatrixRunner UI.
//
